...
export CONTAINERBASE_CACHE_DIR=${CONTAINERBASE_CACHE_DIR:-$BUILDPACK_CACHE_DIR}
...
export CONTAINERBASE_MAX_ALLOCATED_DISK=${CONTAINERBASE_MAX_ALLOCATED_DISK:-$BUILDPACK_MAX_ALLOCATED_DISK}
