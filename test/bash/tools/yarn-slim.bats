...
setup() {
  ...
  # load yarn-slim
  load "$TEST_DIR/../../../src/usr/local/buildpack/tools/v2/yarn-slim.sh"
}
...
@test "yarn-slim: check_tool_requirements" {
  TOOL_NAME=yarn-slim
...
@test "yarn-slim: check_tool_installed" {
  local TOOL_NAME=yarn-slim
  local TOOL_VERSION

  # renovate: datasource=npm lookupName=yarn-slim
